...
def get_circle_dia():
    ...
    # time.sleep(3) # Delay to perform efficient calculation
...
def verifying_diameter_testcase(obtained_diameter,d):
    ...
    if(obtained_diameter == d):
        print('The value of obtained diameter is same as provided diameter')   
         ...
         print('The value of obtained diameter is almost equlavent to the provided diameter with minor difference of: ',obtained_diameter-d)   
...
def verifying_hue_testcase(obtained_hue,hue):
    ...
    if(obtained_hue == hue):
        print('The value of obtained Hue (color) is same as provided Hue (color)')   
         ...
         print('The value of obtained Hue (color) is almost equlavent to the provided Hue (color) with minor difference of: ',obtained_hue-hue)
    # elif(obtained_hue ==0 and hue == 360):
    #      print('The value of obtained Hue (color) is may equlavent to the provided Hue (color)')  
    else:
